...
using UnityEngine;
    ...
    public class SquashAndStretch : MonoBehaviour
    {
        ...
        [SerializeField, Range(0, 1f), Tooltip("In seconds.")] private float animationDuration = 0.25f;
        [SerializeField] private bool canBeOverwritten;
        [SerializeField] private bool playOnStart;
        [SerializeField] private bool playsEveryTime = true;
        [SerializeField, Range(0,100f), Tooltip("Percentage.")] private float chanceToPlay = 100f;
        ...
        [SerializeField, Tooltip("In seconds.")] private float loopingDelay = 0.5f;
